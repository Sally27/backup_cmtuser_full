...
for polarity in ["MagUp", "MagDown"]:
    myJobName = '15'+polarity+'B23MuNuMC'
    tuplename = "Bu23MuNuMC2015_"+polarity+".root"
    ...
    bk_down = BKQuery(path="/MC/2015/Beam6500GeV-2015-"+polarity+"-Nu1.6-25ns-Pythia8/Sim09a/Trig0x411400a2/Reco15a/Turbo02/Stripping24NoPrescalingFlagged/12513070/ALLSTREAMS.DST",dqflag="OK") 
