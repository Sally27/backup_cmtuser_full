#ifndef WSUTCLIFFE_TupleToolVertexCCPippMuMu_H
#define WSUTCLIFFE_TupleToolVertexCCPippMuMu_H 
...
/** @class TupleToolVertexCCPippMuMu TupleToolVertexCCPippMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexCCPippMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexCCPippMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexCCPippMuMu( ){}; ///< Destructor
