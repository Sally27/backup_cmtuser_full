...
// local
#include "TupleToolVertexthreeSSmuonDatapmMuMu.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexthreeSSmuonDatapmMuMu
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexthreeSSmuonDatapmMuMu )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexthreeSSmuonDatapmMuMu::TupleToolVertexthreeSSmuonDatapmMuMu( const std::string& type,
...
StatusCode TupleToolVertexthreeSSmuonDatapmMuMu::initialize()
{
...
StatusCode TupleToolVertexthreeSSmuonDatapmMuMu::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexthreeSSmuonDatapmMuMu.cpp :(" );
...
//                cout<<"X_ID part: "<<"ID of particle 1: "<< (*itmp)->particleID().pid()<<endl;
                ...
                if (((*itmp)->particleID().abspid() == 13) && count==2)
                {
                parts2Vertex.push_back(*itmp);
                mu_part = (*itmp);
...
//
//=========================================================================
StatusCode TupleToolVertexthreeSSmuonDatapmMuMu::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexthreeSSmuonDatapmMuMu::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexthreeSSmuonDatapmMuMu::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexthreeSSmuonDatapmMuMu::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
