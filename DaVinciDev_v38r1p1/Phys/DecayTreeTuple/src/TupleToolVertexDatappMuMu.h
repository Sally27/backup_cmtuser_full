#ifndef WSUTCLIFFE_TupleToolVertexDatappMuMu_H
#define WSUTCLIFFE_TupleToolVertexDatappMuMu_H 
...
/** @class TupleToolVertexDatappMuMu TupleToolVertexDatappMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexDatappMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexDatappMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexDatappMuMu( ){}; ///< Destructor
