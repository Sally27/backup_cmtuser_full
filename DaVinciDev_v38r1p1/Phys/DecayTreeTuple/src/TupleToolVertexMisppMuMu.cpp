...
// local
#include "TupleToolVertexMisppMuMu.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexMisppMuMu
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexMisppMuMu )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexMisppMuMu::TupleToolVertexMisppMuMu( const std::string& type,
...
StatusCode TupleToolVertexMisppMuMu::initialize()
{
...
StatusCode TupleToolVertexMisppMuMu::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexMisppMuMu.cpp :(" );
...
//
//=========================================================================
StatusCode TupleToolVertexMisppMuMu::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexMisppMuMu::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexMisppMuMu::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexMisppMuMu::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
