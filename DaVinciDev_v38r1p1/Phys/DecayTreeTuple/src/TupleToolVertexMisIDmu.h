#ifndef WSUTCLIFFE_TupleToolVertexMisIDmu_H
#define WSUTCLIFFE_TupleToolVertexMisIDmu_H 
...
/** @class TupleToolVertexMisIDmu TupleToolVertexMisIDmu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexMisIDmu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexMisIDmu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexMisIDmu( ){}; ///< Destructor
