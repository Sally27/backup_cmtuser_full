...
// local
#include "TupleToolVertexDataMuMuMu.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexDataMuMuMu
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexDataMuMuMu )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexDataMuMuMu::TupleToolVertexDataMuMuMu( const std::string& type,
...
StatusCode TupleToolVertexDataMuMuMu::initialize()
{
...
StatusCode TupleToolVertexDataMuMuMu::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexDataMuMuMu.cpp :(" );
...
//          cout<<"Particle id: "<<(*itmp)->particleID().pid()<<" Wooooohoooooooooooooooooooooooo!"<<endl;
 ...
 //         cout<<count<<endl;
                ...
                if (((*itmp)->particleID().abspid()  == m_Xid) && count==1)

                {
                parts2Vertex.push_back(*itmp);
                last_part = (*itmp);
//                cout<<"last_ID part: "<<"ID of particle 1: "<< (*itmp)->particleID().pid()<<endl;
                }
...
//
//=========================================================================
StatusCode TupleToolVertexDataMuMuMu::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexDataMuMuMu::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexDataMuMuMu::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexDataMuMuMu::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
