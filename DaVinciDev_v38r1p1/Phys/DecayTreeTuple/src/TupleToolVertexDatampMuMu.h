#ifndef WSUTCLIFFE_TupleToolVertexDatampMuMu_H
#define WSUTCLIFFE_TupleToolVertexDatampMuMu_H 
...
/** @class TupleToolVertexDatampMuMu TupleToolVertexDatampMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexDatampMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexDatampMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexDatampMuMu( ){}; ///< Destructor
