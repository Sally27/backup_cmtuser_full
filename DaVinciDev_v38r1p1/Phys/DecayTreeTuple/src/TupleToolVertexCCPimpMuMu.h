#ifndef WSUTCLIFFE_TupleToolVertexCCPimpMuMu_H
#define WSUTCLIFFE_TupleToolVertexCCPimpMuMu_H 
...
/** @class TupleToolVertexCCPimpMuMu TupleToolVertexCCPimpMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexCCPimpMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexCCPimpMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexCCPimpMuMu( ){}; ///< Destructor
