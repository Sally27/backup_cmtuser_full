...
// local
#include "TupleToolVertexCCPippMuMu.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexCCPippMuMu
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexCCPippMuMu )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexCCPippMuMu::TupleToolVertexCCPippMuMu( const std::string& type,
...
StatusCode TupleToolVertexCCPippMuMu::initialize()
{
...
StatusCode TupleToolVertexCCPippMuMu::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexCCPippMuMu.cpp :(" );
...
//
//=========================================================================
StatusCode TupleToolVertexCCPippMuMu::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexCCPippMuMu::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexCCPippMuMu::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexCCPippMuMu::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
