#ifndef WSUTCLIFFE_TupleToolVertexPions_H
#define WSUTCLIFFE_TupleToolVertexPions_H 
...
/** @class TupleToolVertexPions TupleToolVertexPions.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexPions : public TupleToolBase,
...
public:
  ...
  TupleToolVertexPions( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexPions( ){}; ///< Destructor
