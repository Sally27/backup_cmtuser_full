...
// local
#include "TupleToolVertexthreeSSmuonDatampMuMu.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexthreeSSmuonDatampMuMu
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexthreeSSmuonDatampMuMu )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexthreeSSmuonDatampMuMu::TupleToolVertexthreeSSmuonDatampMuMu( const std::string& type,
...
StatusCode TupleToolVertexthreeSSmuonDatampMuMu::initialize()
{
...
StatusCode TupleToolVertexthreeSSmuonDatampMuMu::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexthreeSSmuonDatampMuMu.cpp :(" );
...
//
//=========================================================================
StatusCode TupleToolVertexthreeSSmuonDatampMuMu::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexthreeSSmuonDatampMuMu::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexthreeSSmuonDatampMuMu::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexthreeSSmuonDatampMuMu::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
