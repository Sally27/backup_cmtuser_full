...
// local
#include "TupleToolVertexMispmMuMu.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexMispmMuMu
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexMispmMuMu )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexMispmMuMu::TupleToolVertexMispmMuMu( const std::string& type,
...
StatusCode TupleToolVertexMispmMuMu::initialize()
{
...
StatusCode TupleToolVertexMispmMuMu::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexMispmMuMu.cpp :(" );
...
//
//=========================================================================
StatusCode TupleToolVertexMispmMuMu::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexMispmMuMu::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexMispmMuMu::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexMispmMuMu::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
