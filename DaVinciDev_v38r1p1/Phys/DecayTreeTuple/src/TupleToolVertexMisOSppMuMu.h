#ifndef WSUTCLIFFE_TupleToolVertexMisOSppMuMu_H
#define WSUTCLIFFE_TupleToolVertexMisOSppMuMu_H 
...
/** @class TupleToolVertexMisOSppMuMu TupleToolVertexMisOSppMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexMisOSppMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexMisOSppMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexMisOSppMuMu( ){}; ///< Destructor
