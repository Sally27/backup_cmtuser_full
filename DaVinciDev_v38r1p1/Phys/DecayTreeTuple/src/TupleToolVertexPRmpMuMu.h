#ifndef WSUTCLIFFE_TupleToolVertexPRmpMuMu_H
#define WSUTCLIFFE_TupleToolVertexPRmpMuMu_H 
...
/** @class TupleToolVertexPRmpMuMu TupleToolVertexPRmpMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexPRmpMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexPRmpMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexPRmpMuMu( ){}; ///< Destructor
