#ifndef WSUTCLIFFE_TupleToolVertexDataMuMuMu_H
#define WSUTCLIFFE_TupleToolVertexDataMuMuMu_H 
...
/** @class TupleToolVertexDataMuMuMu TupleToolVertexDataMuMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexDataMuMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexDataMuMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexDataMuMuMu( ){}; ///< Destructor
