...
// local
#include "TupleToolVertexthreeSSmuonDatappMuMu.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexthreeSSmuonDatappMuMu
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexthreeSSmuonDatappMuMu )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexthreeSSmuonDatappMuMu::TupleToolVertexthreeSSmuonDatappMuMu( const std::string& type,
...
StatusCode TupleToolVertexthreeSSmuonDatappMuMu::initialize()
{
...
StatusCode TupleToolVertexthreeSSmuonDatappMuMu::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexthreeSSmuonDatappMuMu.cpp :(" );
...
//                cout<<"X_ID part: "<<"ID of particle 1: "<< (*itmp)->particleID().pid()<<endl;
                ...
                parts2Vertex.push_back(*itmp);
                mu_part = (*itmp);
//                cout<<"Mu part:  "<< (*itmp)->particleID().pid()<<endl;      
                }
	        }
      }     
      } // if endVertex
...
//
//=========================================================================
StatusCode TupleToolVertexthreeSSmuonDatappMuMu::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexthreeSSmuonDatappMuMu::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexthreeSSmuonDatappMuMu::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexthreeSSmuonDatappMuMu::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
