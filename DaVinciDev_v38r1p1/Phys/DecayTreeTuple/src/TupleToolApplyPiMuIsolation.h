#ifndef TupleToolApplyPiMuIsolation_H
#define TupleToolApplyPiMuIsolation_H 1
 ...
 *  @date   2008-04-15
 */
class TupleToolApplyPiMuIsolation : public TupleToolBase, virtual public IParticleTupleTool {
public:
  /// Standard constructor
  TupleToolApplyPiMuIsolation( const std::string& type,
		     const std::string& name,
		     const IInterface* parent);
  
  virtual ~TupleToolApplyPiMuIsolation( ){}; ///< Destructor
...
private:
  ...
  Float_t opening,minipchi2,newfdchi2,oldfdchi2,ghostprob,trackchi2,deltafd,pt,ip,chi2,type,vertexchi2,Dst_PT,dummy, dlogfd;
  ...
  double getM(std::vector<const LHCb::Particle*> ,std::vector<double>);
  IDVAlgorithm* m_dva;
...
#endif // TupleToolApplyPiMuIsolation_H
