#ifndef WSUTCLIFFE_TupleToolVertexthreeSSmuonDatappMuMu_H
#define WSUTCLIFFE_TupleToolVertexthreeSSmuonDatappMuMu_H 
...
/** @class TupleToolVertexthreeSSmuonDatappMuMu TupleToolVertexthreeSSmuonDatappMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexthreeSSmuonDatappMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexthreeSSmuonDatappMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexthreeSSmuonDatappMuMu( ){}; ///< Destructor
