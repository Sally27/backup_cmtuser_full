#ifndef WSUTCLIFFE_TupleToolVertexMisOSmpMuMu_H
#define WSUTCLIFFE_TupleToolVertexMisOSmpMuMu_H 
...
/** @class TupleToolVertexMisOSmpMuMu TupleToolVertexMisOSmpMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexMisOSmpMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexMisOSmpMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexMisOSmpMuMu( ){}; ///< Destructor
