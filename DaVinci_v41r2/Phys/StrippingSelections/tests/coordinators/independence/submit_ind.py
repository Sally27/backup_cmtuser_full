...
#mydataset="validationReco2016.py"
mydataset="Reco15a_Run164668.py"
mydatasetxml="Reco15a_Run164668.xml"

#linebuilders list to be updated with latest stripping!
linebuilders=['B2XTauMu', 'B2threebody', 'BetaSPi0', 'Ccbar2PpbarExclusive', 'ChargedHyperons', 'D2XMuMuSS', 'DstarPromptWithD02HHLL', 'LFV', 'Lambdac2V0H', 'TaggedJets', 'We', 'Xibc', 'Bc2JpsiMu', 'Beauty2XGamma', 'BetaS', 'Bu2hhh', 'D2HHHPi0', 'D2hhhFTCalib', 'DY2MuMu', 'DstarD2XGamma', 'ZVTOP', 'BadEvents', 'Bd2JpsieeKS', 'Bu2MuNu', 'CharmAssociative', 'DstarD02xx', 'DstarD2HHHH', 'HeavyBaryon', 'HighPtTau', 'MiniBias', 'Z02ee', 'B2CharmlessQ2B', 'D2HMuNu', 'DY2ee', 'DstarPromptWithD02HHMuMuControl', 'ExcitedDsSpectroscopy', 'Exotica', 'Kshort2MuMuMuMu', 'Tau2LambdaMu', 'B2XuMuNu', 'B2fourbody', 'B2pphh', 'CC2DD', 'D2HHHKs', 'DstarD2KShh', 'LowMultINC', 'RareStrange', 'A2MuMu', 'B2DDphi', 'B2Lambda0Mu', 'Ccbar2PPPiPi', 'D2EtaPrimeH', 'DiMuonInherit', 'DisplVertices', 'Ditau', 'Tau23Mu', 'WmuJets', 'Xb2p3h', 'Bd2DstarMuNu', 'A1MuMu', 'B2JpsiHH', 'B2KShh', 'B2KstTauTau', 'B2Ksthh', 'B2LLXBDT', 'Bc2Ds1Gamma', 'Ccbar2Phi', 'D2EtaH', 'Lambdac2V2H', 'Lb2EtacKp', 'B23MuNu', 'B2DMuNuX', 'B2HHPi0', 'B2Kpi0Lines', 'B2XTauNuAllLines', 'Bc2hhh', 'Beauty2Charm', 'Beauty2XGammaNoBias', 'Bs2GammaGamma', 'D2Pi0H', 'DarkBoson', 'DstarD2KSHHPi0', 'HltQEEJets', 'Kshort2PiPiMuMu', 'Lb2L0Gamma', 'PromptCharm', 'SingleTrackTIS', 'WRareDecay', 'Xb23ph', 'bhad2PMuX', 'A2MuMuSameSign', 'B24p', 'B2DstMuNuIncl', 'B2XMuMu', 'BLV', 'Ccbar2Ppbar', 'Lc23Mu', 'XicHHH', 'Z0RareDecay', 'Bbbar2PhiPhi', 'Bc2JpsiHBDT', 'D2EtaEEGH', 'D2PhiH', 'Lambdac2V03H', 'MicroDiJets', 'B2DMuForTauMu', 'B2KShhh', 'Bs2MuMuLines', 'Bs2st2KKMuX', 'Bu2LLK', 'Ccbar2PpbarDetached', 'Hb2Charged2Body', 'InclQQ', 'StrangeBaryons', 'B2ppipiSigmacmm_Lcpi', 'Beauty2XGammaExclusive', 'BetaSBs2JpsieePhi', 'Bs2EtacPhiBDT', 'Bu2Ksthh', 'CC2DDcontrol', 'Ccbar2PhiPhiPiPi', 'CharmFromBSemi', 'Omegab2XicKpi', 'RnS', 'XB2DPiP', 'B2MuMuMuMu', 'Bc3h', 'BetaSBs2PhiPhi', 'ChiCJPsiGammaConv', 'H24Mu', 'Hb2V0V0h', 'LLP2MuX', 'Lb2dp', 'WeJets', 'Z02MuMu', 'B2XLL', 'Hypb2L0HGamma', 'Bd2eeKstarBDT', 'Bs2K0stK0st', 'CharmForVub', 'Dst2PiD0EEG', 'WMu', 'B2HHBDT', 'B2XTau', 'B2twobody', 'D2hh', 'DstarD0ToHHPi0', 'FullDiJets', 'HltQEEExotica', 'Lb2V0h', 'MuMuSS', 'PhiToKSKS', 'SbarSCorrelations', 'StrangeBaryonsNoPID']
