#ifndef WSUTCLIFFE_TupleToolVertexthreeSSmuonDatampMuMu_H
#define WSUTCLIFFE_TupleToolVertexthreeSSmuonDatampMuMu_H 
...
/** @class TupleToolVertexthreeSSmuonDatampMuMu TupleToolVertexthreeSSmuonDatampMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexthreeSSmuonDatampMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexthreeSSmuonDatampMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexthreeSSmuonDatampMuMu( ){}; ///< Destructor
