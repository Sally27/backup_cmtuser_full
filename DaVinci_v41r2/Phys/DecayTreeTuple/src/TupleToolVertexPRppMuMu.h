#ifndef WSUTCLIFFE_TupleToolVertexPRppMuMu_H
#define WSUTCLIFFE_TupleToolVertexPRppMuMu_H 
...
/** @class TupleToolVertexPRppMuMu TupleToolVertexPRppMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexPRppMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexPRppMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexPRppMuMu( ){}; ///< Destructor
