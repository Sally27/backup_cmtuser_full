...
// local
#include "TupleToolVertexPRMuMuMu.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexPRMuMuMu
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexPRMuMuMu )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexPRMuMuMu::TupleToolVertexPRMuMuMu( const std::string& type,
    ...
    , m_pVertexFit(0)
{
  ...
  declareProperty("XID",m_Xid=211);
}

//=============================================================================

StatusCode TupleToolVertexPRMuMuMu::initialize()
{
...
StatusCode TupleToolVertexPRMuMuMu::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexPRMuMuMu.cpp :(" );
...
//          cout<<"Particle id: "<<(*itmp)->particleID().pid()<<" Wooooohoooooooooooooooooooooooo!"<<endl;
 ...
 //         cout<<count<<endl;
                ...
                if (((*itmp)->particleID().pid()  == m_Xid))

                {
                parts2Vertex.push_back(*itmp);
                last_part = (*itmp);
//               cout<<"last_ID part: "<<"ID of particle 2: "<< (*itmp)->particleID().pid()<<endl;
                }
...
//
//=========================================================================
StatusCode TupleToolVertexPRMuMuMu::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexPRMuMuMu::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexPRMuMuMu::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexPRMuMuMu::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
