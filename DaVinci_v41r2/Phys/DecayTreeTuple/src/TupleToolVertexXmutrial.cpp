...
// local
#include "TupleToolVertexXmutrial.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexXmutrial
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexXmutrial )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexXmutrial::TupleToolVertexXmutrial( const std::string& type,
...
StatusCode TupleToolVertexXmutrial::initialize()
{
...
StatusCode TupleToolVertexXmutrial::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexXmutrial.cpp :(" );
...
//
//=========================================================================
StatusCode TupleToolVertexXmutrial::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexXmutrial::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexXmutrial::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexXmutrial::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
