#ifndef WSUTCLIFFE_TupleToolVertexPRMuMuMu_H
#define WSUTCLIFFE_TupleToolVertexPRMuMuMu_H 
...
/** @class TupleToolVertexPRMuMuMu TupleToolVertexPRMuMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexPRMuMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexPRMuMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexPRMuMuMu( ){}; ///< Destructor
