...
// local
#include "TupleToolVertexMisOSmpMuMu.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexMisOSmpMuMu
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexMisOSmpMuMu )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexMisOSmpMuMu::TupleToolVertexMisOSmpMuMu( const std::string& type,
...
StatusCode TupleToolVertexMisOSmpMuMu::initialize()
{
...
StatusCode TupleToolVertexMisOSmpMuMu::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexMisOSmpMuMu.cpp :(" );
		  ...
		  if(!((*isource)->daughters().empty())){
			  ...
			  for( LHCb::Particle::ConstVector::const_iterator itmp = tmp.begin(); 
				  ...
				  target.push_back(*itmp);
                                  muon=muon+1;
				  //          cout<<"daugther Particle id: "<<(*itmp)->particleID().pid()<<" Wooooohoooooooooooooooooooooooo!"<<endl;
				  if (((*itmp)->particleID().abspid()  == 13) && muon==2)
				  {
					  parts2Vertex.push_back(*itmp);
					  mu_part = (*itmp);
...
//
//=========================================================================
StatusCode TupleToolVertexMisOSmpMuMu::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexMisOSmpMuMu::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexMisOSmpMuMu::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexMisOSmpMuMu::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
