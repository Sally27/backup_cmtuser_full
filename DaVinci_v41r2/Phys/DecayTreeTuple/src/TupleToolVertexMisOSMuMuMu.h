#ifndef WSUTCLIFFE_TupleToolVertexMisOSMuMuMu_H
#define WSUTCLIFFE_TupleToolVertexMisOSMuMuMu_H 
...
/** @class TupleToolVertexMisOSMuMuMu TupleToolVertexMisOSMuMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexMisOSMuMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexMisOSMuMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexMisOSMuMuMu( ){}; ///< Destructor
