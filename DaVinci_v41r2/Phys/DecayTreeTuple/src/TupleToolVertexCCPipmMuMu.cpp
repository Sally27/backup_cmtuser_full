...
// local
#include "TupleToolVertexCCPipmMuMu.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexCCPipmMuMu
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexCCPipmMuMu )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexCCPipmMuMu::TupleToolVertexCCPipmMuMu( const std::string& type,
...
StatusCode TupleToolVertexCCPipmMuMu::initialize()
{
...
StatusCode TupleToolVertexCCPipmMuMu::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexCCPipmMuMu.cpp :(" );
...
//
//=========================================================================
StatusCode TupleToolVertexCCPipmMuMu::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexCCPipmMuMu::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexCCPipmMuMu::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexCCPipmMuMu::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
