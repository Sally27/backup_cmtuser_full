#ifndef WSUTCLIFFE_TupleToolVertexXmutrial_H
#define WSUTCLIFFE_TupleToolVertexXmutrial_H 
...
/** @class TupleToolVertexXmutrial TupleToolVertexXmutrial.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexXmutrial : public TupleToolBase,
...
public:
  ...
  TupleToolVertexXmutrial( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexXmutrial( ){}; ///< Destructor
