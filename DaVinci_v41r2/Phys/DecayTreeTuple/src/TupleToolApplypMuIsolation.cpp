...
DECLARE_TOOL_FACTORY( TupleToolApplypMuIsolation );

using namespace LHCb;
//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
TupleToolApplypMuIsolation::TupleToolApplypMuIsolation( const std::string& type,
...
StatusCode TupleToolApplypMuIsolation::fill( const Particle* mother
                                    , const Particle* P
...
//  
//=========================================================================
const Vertex* TupleToolApplypMuIsolation::originVertex( const Particle* top
...
//=============================================================================
double TupleToolApplypMuIsolation::getminipchi(const LHCb::Particle* track){
...
double TupleToolApplypMuIsolation::getfdchi2(const LHCb::Track* track, LHCb::Vertex Vtx){
...
double TupleToolApplypMuIsolation::getM(std::vector<const LHCb::Particle*> pvect ,std::vector<double> Mvect)
    {
