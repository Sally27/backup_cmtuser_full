...
for polarity in ["MagUp", "MagDown"]:
    ...
    job_name = 'StrippingB23MuNusignal'+polarity+'2016'
    
    #sandbox = []
    
    #dv = DaVinci()
    dv = DaVinci(version="v41r2", platform = 'x86_64-slc6-gcc49-opt', optsfile = [ '/home/hep/ss4314/cmtuser/DaVinci_v41r2/tuplemaking/combinatorial2016/B23MuNuSignalData.py' ])
    ...
    bk_down = BKQuery(path="/LHCb/Collision16/Beam6500GeV-VeloClosed-"+polarity+"/Real Data/Reco16/Stripping26/90000000/SEMILEPTONIC.DST",dqflag="OK")
...
#      postprocessors = myMerger,
    ...
    j.inputfiles =[LocalFile("/home/hep/ss4314/cmtuser/DaVinci_v41r2/tuplemaking/combinatorial2016/weights_110614_Lc_pX.xml")]
