...
for polarity in ["MagDown","MagUp"]:
    myJobName = '16'+polarity+'B2mumupiMCMC'
    tuplename = "B2mumupiMC_2016_"+polarity+".root"
    myApplication = DaVinci(version="v41r2")#,platform = 'x86_64-slc6-gcc48-opt')
    myApplication.optsfile = ['/home/hep/ss4314/cmtuser/DaVinci_v41r2/tuplemaking/mumupimc2016/B23MuNuSignalSelection_ALL.py']
    ...
    bk_down = BKQuery(path="/MC/2016/Beam6500GeV-2016-"+polarity+"-Nu1.6-25ns-Pythia8/Sim09b/Trig0x6138160F/Reco16/Turbo03/Stripping26NoPrescalingFlagged/12113023/ALLSTREAMS.DST",dqflag="OK") 
    ...
    j.inputfiles =[ LocalFile("/home/hep/ss4314/cmtuser/DaVinci_v41r2/tuplemaking/mumupimc2016/weights_110614_Lc_pX.xml")] 
