...
#
from StrippingArchive.Stripping26.StrippingB2CC.StrippingB2JpsiXforBeta_s import B2JpsiXforBeta_sConf as builder
from StrippingArchive.Stripping26.StrippingB2CC.StrippingB2JpsiXforBeta_s import default_config as config
...
from Configurables import DaVinci
DaVinci().TupleFile = "BuKMuMuMC2016_Strip26.root"
...
IOHelper().inputFiles(['./00056595_00000012_3.AllStreams.dst'], clear=True)
