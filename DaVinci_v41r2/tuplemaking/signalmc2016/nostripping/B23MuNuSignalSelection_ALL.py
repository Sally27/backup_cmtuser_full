...
from Configurables import DecayTreeTuple, TupleToolPid ,FilterDesktop,CombineParticles,FitDecayTrees, TupleToolRecoStats, TupleToolTrigger, TupleToolTISTOS, CondDB
...
#
from StrippingArchive.Stripping26.StrippingSL.StrippingB23MuNu import B23MuNuConf as builder
from StrippingArchive.Stripping26.StrippingSL.StrippingB23MuNu import default_config as config
...
config['B23MuNu']['CONFIG']['Muon_PIDmu'] = -999999
config['B23MuNu']['CONFIG']['Muon_PIDmuK'] = -999999

stripping='stripping26'
#get the configuration dictionary from the database
#config  = strippingConfiguration(stripping)
#config['HLT_FILTER_HMuNu']=""
lb = builder('B23MuNu',config['B23MuNu']['CONFIG'])
print config
