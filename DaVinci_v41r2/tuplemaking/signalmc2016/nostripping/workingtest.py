...
lb = builder('B23MuNuConf',config['B23MuNu']['CONFIG'])
#print config
...
for line in lb.lines():
    if line.name() == 'StrippingB23MuNuConf_TriMuLine':
...
stripsel = AutomaticData(Location = "/Phys/StrippingB23MuNuConf_TriMuLine/Particles")
...
#tuple.Inputs = ['Phys/StrippingB23MuNuConf_TriMuLine/Particles']
