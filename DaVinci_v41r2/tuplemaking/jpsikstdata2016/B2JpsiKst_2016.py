...
stripsel = AutomaticData(Location = "/Event/Leptonic/Phys/B2XMuMu_Line/Particles")
...
#from Configurables import DaVinci
DaVinci().TupleFile = "BuKstMuMu_2016.root"
...
#IOHelper().inputFiles(['./00053935_00000998_1.leptonic.mdst'], clear=True)
