...
for polarity in ["MagUp", "MagDown"]:
    myJobName = '16'+polarity+'B2JpsiKMC'
    tuplename = "BuKMuMuMC2016_Strip26locally_noKaonPID_noMuonPID_"+polarity+".root"
    myApplication = DaVinci(version="v41r2")#,platform = 'x86_64-slc6-gcc48-opt')
    myApplication.optsfile = ['/home/hep/ss4314/cmtuser/DaVinci_v41r2/tuplemaking/controlchannelrun1B2CC/mcDIY2016/BuJpsiK_MC_2016_ALL.py']
    ...
    bk_down = BKQuery(path="/MC/2016/Beam6500GeV-2016-"+polarity+"-Nu1.6-25ns-Pythia8/Sim09b/Trig0x6138160F/Reco16/Turbo03/Stripping26NoPrescalingFlagged/12143001/ALLSTREAMS.DST",dqflag="OK") 
