...
from Configurables import DecayTreeTuple, FitDecayTrees, TupleToolRecoStats, TupleToolTrigger, TupleToolTISTOS, CondDB, SelDSTWriter, FilterDesktop, TupleToolPid
...
#
from testlocallyStrip24 import B2JpsiXforBeta_sConf as builder
from testlocallyStrip24 import default_config as config
from StrippingConf.Configuration import StrippingConf, StrippingStream
#from StrippingSettings.Utils import strippingConfiguration
#from StrippingArchive.Utils import buildStreams, cloneLinesFromStream
#from StrippingArchive import strippingArchive
#config['MuonPID'] = -999999
#config['CONFIG']['BPVLTIME'] = 0.2

stripping='stripping24'
#get the configuration dictionary from the database
#config  = strippingConfiguration(stripping)
#config['HLT_FILTER_HMuNu']=""
lb = builder('BetaS',config['CONFIG'])
print config
...
for line in lb.lines():
    if line.name() == 'StrippingBetaSBu2JpsiKDetachedLine':
...
stripsel = AutomaticData(Location = "Phys/BetaSBu2JpsiKDetachedLine/Particles")
...
tuple.Inputs = ["Phys/BetaSBu2JpsiKDetachedLine/Particles"]
...
from Configurables import DaVinci
#DaVinci().TupleFile = "BuKMuMuMC2016_Strip26locally_noKaonPID_noMuonPID.root"
...
#dddb-20150724 
# BenderTools.GetDBtags     INFO        SIMCOND : sim-20161124-2-vc-md100 
