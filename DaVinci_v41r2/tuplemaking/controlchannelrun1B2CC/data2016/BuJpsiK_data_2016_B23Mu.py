...
from Configurables import DecayTreeTuple, FitDecayTrees, TupleToolRecoStats, TupleToolTrigger, TupleToolTISTOS, CondDB, FilterDesktop, TupleToolPid
...
tuple.Inputs = ["/Event/Dimuon/Phys/BetaSBu2JpsiKDetachedLine/Particles"]
...
#from Configurables import DaVinci
DaVinci().TupleFile = "BuKMuMu2016.root"
...
#IOHelper().inputFiles(['./00049592_00006480_1.dimuon.dst'], clear=True)
