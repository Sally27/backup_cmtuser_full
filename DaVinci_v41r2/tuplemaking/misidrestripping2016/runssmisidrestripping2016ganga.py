...
job_name = 'MisIDSSrestrip2016'

#sandbox = []

#dv = DaVinci()
dv = DaVinci(version="v41r2", optsfile = [ '/home/hep/ss4314/cmtuser/DaVinci_v41r2/tuplemaking/misidrestripping2016/runssmisidrestripping2016.py' ])
