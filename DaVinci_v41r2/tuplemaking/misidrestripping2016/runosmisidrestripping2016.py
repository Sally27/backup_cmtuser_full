...
tuple2.ToolList += [ "TupleToolPid" ]
tuple2.addTool( TupleToolPid, name = "TupleToolPid")
tuple2.TupleToolPid.Verbose = True
...
from DecayTreeTuple.Configuration import *
from Configurables import TupleToolVertexMisOSppMuMu
tuple2.Bplus.addTool(TupleToolVertexMisOSppMuMu)
tuple2.Bplus.ToolList+=["TupleToolVertexMisOSppMuMu"]
#
#
from DecayTreeTuple.Configuration import *
from Configurables import TupleToolVertexMisOSpmMuMu
tuple2.Bplus.addTool(TupleToolVertexMisOSpmMuMu)
tuple2.Bplus.ToolList+=["TupleToolVertexMisOSpmMuMu"]
#
#
from DecayTreeTuple.Configuration import *
from Configurables import TupleToolVertexMisOSmpMuMu
tuple2.Bplus.addTool(TupleToolVertexMisOSmpMuMu)
tuple2.Bplus.ToolList+=["TupleToolVertexMisOSmpMuMu"]
#
from DecayTreeTuple.Configuration import *
from Configurables import TupleToolVertexMisOSMuMuMu
tuple2.Bplus.addTool(TupleToolVertexMisOSMuMuMu)
tuple2.Bplus.ToolList+=["TupleToolVertexMisOSMuMuMu"]
#
#
from DecayTreeTuple.Configuration import *
from Configurables import TupleToolSallyOSmis
tuple2.Bplus.addTool(TupleToolSallyOSmis)
tuple2.Bplus.ToolList+=["TupleToolSallyOSmis"]
#
...
DaVinci().TupleFile = "B23MuNuFakeOS.root"
...
#IOHelper().inputFiles(['./00050733_00021988_1.semileptonic.dst'])
#,'./00050733_00021228_1.semileptonic.dst','./00050733_00013091_1.semileptonic.dst'], clear=True)
# database
