...
job_name = 'MisIDOS16restrip'

#sandbox = []

#dv = DaVinci()
dv = DaVinci(version="v41r2", platform = 'x86_64-slc6-gcc49-opt', optsfile = [ '/home/hep/ss4314/cmtuser/DaVinci_v41r2/tuplemaking/misidrestripping2016/runosmisidrestripping2016.py' ])
...
#ds = dv.readInputData("/afs/cern.ch/user/s/slstefko/cmtuser/DaVinci_v35r0/Phys/StrippingSelections/tests/data/Reco14_Run125153.py")

#bk_down = BKQuery(type="Run",i"/LHCb/Collision12/Beam4000GeV-VeloClosed-MagDown/RealData/Reco14/90000000/FULL.DST")

bk_down = BKQuery(path="/LHCb/Collision16/Beam6500GeV-VeloClosed-MagDown/Real Data/Reco16/Stripping26/90000000/SEMILEPTONIC.DST",dqflag="OK")
data = bk_down.getDataset()

bk_up = BKQuery(path="/LHCb/Collision16/Beam6500GeV-VeloClosed-MagUp/Real Data/Reco16/Stripping26/90000000/SEMILEPTONIC.DST",dqflag="OK")
...
j.inputfiles =[ LocalFile("/home/hep/ss4314/cmtuser/DaVinci_v41r2/tuplemaking/misidrestripping2016/weights_110614_Lc_pX.xml")]
