...
for polarity in ["MagUp", "MagDown"]:
    myJobName = '16'+polarity+'LambdaB2JpsipKMC'
    tuplename = "LambdaB2JpsipKMC_2016_"+polarity+".root"
    myApplication = DaVinci(version="v41r2")#,platform = 'x86_64-slc6-gcc48-opt')
    myApplication.optsfile = ['/home/hep/ss4314/cmtuser/DaVinci_v41r2/tuplemaking/lambdab2pkmumu2016/Lambdab2jpsikpi_OriginalDescriptor.py']
    ...
    bk_down = BKQuery(path="/MC/2016/Beam6500GeV-2016-"+polarity+"-Nu1.6-25ns-Pythia8/Sim09b/Trig0x6138160F/Reco16/Turbo03/Stripping26NoPrescalingFlagged/15144001/ALLSTREAMS.DST",dqflag="OK") 
