# file /home/hep/ss4314/cmtuser/Gauss_v45r10p1/Gen/DecFiles/options/43900073.py generated: Wed, 25 Jan 2017 15:25:29
#
# Event Type: 43900073
#
# ASCII decay Descriptor: pp->(  H_20 -> ( H_30 -> c anti-c ) ( H_30 -> c anti-c) )
#
from Configurables import Generation
Generation().EventType = 43900073
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Higgs_AA,cccc=mH125GeV,mA35GeV,tA10ps,HidValley.dec"
Generation().Special.CutTool = ""
Generation().FullGenEventCutTool = "LoKi::FullGenEventCut/FourTracksFromHVPionInAcceptance"
from Configurables import LHCb__ParticlePropertySvc
LHCb__ParticlePropertySvc().Particles = [ "H_20 88 35 0.0 125.0 1.65e-22 Higgs'0 35 4.0e-03" , "H_30 89 36 0.0  35.0 1.0e-11      A0 36 0.0e+00" ]
