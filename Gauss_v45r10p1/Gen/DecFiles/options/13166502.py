# file /home/hep/ss4314/cmtuser/Gauss_v45r10p1/Gen/DecFiles/options/13166502.py generated: Wed, 25 Jan 2017 15:25:22
#
# Event Type: 13166502
#
# ASCII decay Descriptor: {[[B_s0]nos -> (D*(2007)~0 -> (D~0 => (KS0 -> pi+ pi-) pi+ pi-) (pi0 -> gamma gamma )) (K*(892)~0 ->K- pi+) ]cc, [[B_s0]os -> (D*(2007)0 -> (D0 => (KS0 -> pi+ pi-) pi+ pi-) (pi0-> gamma gamma) ) (K*(892)0 ->K+ pi-) ]cc}
#
from Configurables import Generation
Generation().EventType = 13166502
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Bs_Dst0Kst0,D0pi0,KSpipi=TightCut,HELAMP100.dec"
