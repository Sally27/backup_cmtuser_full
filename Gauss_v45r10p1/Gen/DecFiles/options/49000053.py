# file /home/hep/ss4314/cmtuser/Gauss_v45r10p1/Gen/DecFiles/options/49000053.py generated: Wed, 25 Jan 2017 15:25:16
#
# Event Type: 49000053
#
# ASCII decay Descriptor: pp -> (b-jet + b-jet) ...
#
from Configurables import Generation
Generation().EventType = 49000053
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/dijet=b,pt20,pt50GeV.dec"
...
twoToTwoInAcc.Preambulo += [
    ...
    "out1 = ( ( GBARCODE == 5 ) "
    "& ( GTHETA < 400.0*mrad ) & ( GPT > 20.0*GeV ) )",
    "out2 = ( ( GBARCODE == 6 ) "
    "& ( GTHETA < 400.0*mrad ) & ( GPT > 20.0*GeV ) )"]
