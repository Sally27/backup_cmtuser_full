# file /home/hep/ss4314/cmtuser/Gauss_v45r10p1/Gen/DecFiles/options/13166103.py generated: Wed, 25 Jan 2017 15:25:15
#
# Event Type: 13166103
#
# ASCII decay Descriptor: {[[B_s0]nos -> (D~0 => (KS0 -> pi+ pi-) pi+ pi-)(K*(892)~0 ->K- pi+) ]cc,[[B_s0]os ->(D0 => (KS0 -> pi+ pi-) pi+ pi-)(K*(892)0 ->K+ pi-) ]cc}
#
from Configurables import Generation
Generation().EventType = 13166103
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Bs_D0Kst,KSpipi=B-SVS,D-PHSP,TightCut.dec"
