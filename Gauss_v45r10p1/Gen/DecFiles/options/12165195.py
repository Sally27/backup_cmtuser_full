# file /home/hep/ss4314/cmtuser/Gauss_v45r10p1/Gen/DecFiles/options/12165195.py generated: Wed, 25 Jan 2017 15:25:34
#
# Event Type: 12165195
#
# ASCII decay Descriptor: [B+ -> (D~0 -> K+ K-) (K*(892)+ -> (Ks -> pi+ pi-) pi+)]cc
#
from Configurables import Generation
Generation().EventType = 12165195
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Bu_D0Kst+,KK,KSpi=TightCut.dec"
...
tightCut.Preambulo += [
    ...
    'goodDDaugK   = (GNINTREE (("K+" == GABSID) & (GP > 1500 * MeV) & inAcc, 4) > 1.5)',
