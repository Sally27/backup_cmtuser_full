# file /home/hep/ss4314/cmtuser/Gauss_v45r10p1/Gen/DecFiles/options/16677060.py generated: Wed, 25 Jan 2017 15:25:22
#
# Event Type: 16677060
#
# ASCII decay Descriptor: [Xi_bc+ -> (Xi_cc++ -> (Lambda_c+ -> p+ K- pi+) K- pi+ pi+) anti-nu_mu mu-]cc
#
from Configurables import Generation
Generation().EventType = 16677060
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Xibc_Xiccppmunu,LcKpipi,pKpi=DecProdCut,m=6.9GeV,t=0.4ps.dec"
