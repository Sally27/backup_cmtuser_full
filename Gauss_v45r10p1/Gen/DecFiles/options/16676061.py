# file /home/hep/ss4314/cmtuser/Gauss_v45r10p1/Gen/DecFiles/options/16676061.py generated: Wed, 25 Jan 2017 15:25:27
#
# Event Type: 16676061
#
# ASCII decay Descriptor: [Xi_bc0 -> (Xi_cc+ -> (Lambda_c+ -> p+ K- pi+) K- pi+) anti-nu_mu mu-]cc
#
from Configurables import Generation
Generation().EventType = 16676061
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Xibc_Xiccpmunu,LcKpi,pKpi=DecProdCut,m=6.9GeV,t=0.4ps.dec"
