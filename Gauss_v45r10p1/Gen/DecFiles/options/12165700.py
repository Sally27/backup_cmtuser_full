# file /home/hep/ss4314/cmtuser/Gauss_v45r10p1/Gen/DecFiles/options/12165700.py generated: Wed, 25 Jan 2017 15:25:19
#
# Event Type: 12165700
#
# ASCII decay Descriptor: [B+ -> (rho+ -> pi+ (pi0 -> gamma gamma)) (anti-D*0 -> (anti-D0 -> (K_S0 -> pi+ pi-) K+ K-) gamma)]cc
#
from Configurables import Generation
Generation().EventType = 12165700
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Bu_Dst0rho+,D0gamma,KSKK=TightCut.dec"
...
tightCut.Preambulo += [
   ...
   'goodD0K  = (GNINTREE( ("K+"==GABSID) & (GP > 1000 * MeV) & (GPT > 50 * MeV) & inAcc, 1) > 1.5)',
