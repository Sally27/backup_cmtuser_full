# file /home/hep/ss4314/cmtuser/Gauss_v45r10p1/Gen/DecFiles/options/13166312.py generated: Wed, 25 Jan 2017 15:25:28
#
# Event Type: 13166312
#
# ASCII decay Descriptor: [[([B_s0]nos -> ^(D*(2007)~0 -> ^(D~0 -> ^(KS0 -> ^pi+ ^pi-) ^K+ ^K-) ^gamma ) ^(K*(892)~0  -> ^K- ^pi+))]CC, [([B_s0]os -> ^(D*(2007)0 -> ^(D0 -> ^(KS0 -> ^pi+ ^pi-) ^K+ ^K-) ^gamma ) ^(K*(892)0 -> ^K+ ^pi-))]CC]
#
from Configurables import Generation
Generation().EventType = 13166312
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Bs_Dst0Kst0,D0gamma,KSKK=TightCut,HELAMP100.dec"
...
tightCut.Preambulo += [
   ...
   'goodDDaugPi  = (GNINTREE( ("K+"==GABSID) & (GP > 1000 * MeV) & inAcc, 1) > 1.5)',
