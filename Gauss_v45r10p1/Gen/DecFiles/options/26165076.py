# file /home/hep/ss4314/cmtuser/Gauss_v45r10p1/Gen/DecFiles/options/26165076.py generated: Wed, 25 Jan 2017 15:25:25
#
# Event Type: 26165076
#
# ASCII decay Descriptor: [ Lambda_c(2625)+ -> ( Lambda_c+ -> p+ K- pi+) pi+ pi-]cc
#
from Configurables import Generation
Generation().EventType = 26165076
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Lambdac2625,Lc,pKpi=phsp,TightCut.dec"
Generation().SignalRepeatedHadronization.CutTool = "LoKi::GenCutTool/TightCut"
Generation().SignalRepeatedHadronization.SignalPIDList = [ 4214,-4214 ]
from Configurables import LHCb__ParticlePropertySvc
LHCb__ParticlePropertySvc().Particles = [ "Sigma_c*+  62  4214 1.0 2.6281 1.3164e-021      Sigma_c*+  4214 0.025", "Sigma_c*~- 63 -4214 -1.0 2.6281 1.3164e-021 anti-Sigma_c*- -4214 0.025" ]
