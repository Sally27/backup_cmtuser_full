# file /home/hep/ss4314/cmtuser/Gauss_v45r10p1/Gen/DecFiles/options/12145401.py generated: Wed, 25 Jan 2017 15:25:14
#
# Event Type: 12145401
#
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Bu_KOmegaJpsi,pi0pi+pi-=PHSP,mm=TightCut_JpsiOmegaCUT.dec"
...
tightCut.Preambulo += [
    ...
    "JpsiOmegaEdge =  GMASS('J/psi(1S)'== GID , 'omega(782)'== GID) < 4200 * MeV",
    ...
    'goodB     = ( GCTAU > 0.1e-3 * ns * c_light ) & JpsiOmegaEdge']
