# file /home/hep/ss4314/cmtuser/Gauss_v45r10p1/Gen/DecFiles/options/14145290.py generated: Wed, 25 Jan 2017 15:25:29
#
# Event Type: 14145290
#
# ASCII decay Descriptor: [B_c+ -> (B*+ -> (B+ -> (J/psi(1S) -> mu+ mu-) pi+ ) gamma ) pi+ pi-]cc
#
from Gaudi.Configuration import *
importOptions( "$DECFILESROOT/options/Bc2sstarVegPyOpts.py" )
from Configurables import Generation
Generation().EventType = 14145290
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Bc2st_Bcstpipi,Bcgamma,Jpsipi,mm=DecProdCut,BcVegPy.dec"
