...
// local
#include "TupleToolVertexPRpmMuMu.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexPRpmMuMu
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexPRpmMuMu )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexPRpmMuMu::TupleToolVertexPRpmMuMu( const std::string& type,
...
StatusCode TupleToolVertexPRpmMuMu::initialize()
{
...
StatusCode TupleToolVertexPRpmMuMu::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexPRpmMuMu.cpp :(" );
...
//                cout<<"X_ID part: "<<"ID of particle 1: "<< (*itmp)->particleID().pid()<<endl;
                ...
                parts2Vertex.push_back(*itmp);
                mu_part = (*itmp);
//                cout<<"Mu part: "<<" ID of particle 2: "<< (*itmp)->particleID().pid()<<endl;      
                }
	        }
      }     
      } // if endVertex
...
//
//=========================================================================
StatusCode TupleToolVertexPRpmMuMu::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexPRpmMuMu::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexPRpmMuMu::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexPRpmMuMu::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
