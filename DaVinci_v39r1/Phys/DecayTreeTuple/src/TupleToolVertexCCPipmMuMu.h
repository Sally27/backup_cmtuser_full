#ifndef WSUTCLIFFE_TupleToolVertexCCPipmMuMu_H
#define WSUTCLIFFE_TupleToolVertexCCPipmMuMu_H 
...
/** @class TupleToolVertexCCPipmMuMu TupleToolVertexCCPipmMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexCCPipmMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexCCPipmMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexCCPipmMuMu( ){}; ///< Destructor
