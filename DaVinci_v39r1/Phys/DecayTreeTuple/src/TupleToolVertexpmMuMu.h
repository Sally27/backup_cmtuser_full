#ifndef WSUTCLIFFE_TupleToolVertexpmMuMu_H
#define WSUTCLIFFE_TupleToolVertexpmMuMu_H 
...
/** @class TupleToolVertexpmMuMu TupleToolVertexpmMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexpmMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexpmMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexpmMuMu( ){}; ///< Destructor
