#ifndef TupleToolApplyKMuIsolation_H
#define TupleToolApplyKMuIsolation_H 1
 ...
 *  @date   2008-04-15
 */
class TupleToolApplyKMuIsolation : public TupleToolBase, virtual public IParticleTupleTool {
public:
  /// Standard constructor
  TupleToolApplyKMuIsolation( const std::string& type,
		     const std::string& name,
		     const IInterface* parent);
  
  virtual ~TupleToolApplyKMuIsolation( ){}; ///< Destructor
...
#endif // TupleToolApplyKMuIsolation_H
