#ifndef WSUTCLIFFE_TupleToolVertexMispmMuMu_H
#define WSUTCLIFFE_TupleToolVertexMispmMuMu_H 
...
/** @class TupleToolVertexMispmMuMu TupleToolVertexMispmMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexMispmMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexMispmMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexMispmMuMu( ){}; ///< Destructor
