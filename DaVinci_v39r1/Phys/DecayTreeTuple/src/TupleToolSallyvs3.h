...
/** @class TupleToolSallyvs3 TupleToolSallyvs3.h jborel/TupleToolSallyvs3.h
 *
 *
 * \sa DecayTreeTuple
 *
...
class TupleToolSallyvs3 : public TupleToolBase, virtual public IParticleTupleTool {

public:
  /// Standard constructor
  TupleToolSallyvs3( const std::string& type,
		    const std::string& name,
		    const IInterface* parent);

  virtual ~TupleToolSallyvs3(){}; ///< Destructor
