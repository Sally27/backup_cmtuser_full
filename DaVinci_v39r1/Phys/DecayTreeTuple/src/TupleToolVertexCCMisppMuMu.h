#ifndef WSUTCLIFFE_TupleToolVertexCCMisppMuMu_H
#define WSUTCLIFFE_TupleToolVertexCCMisppMuMu_H 
...
/** @class TupleToolVertexCCMisppMuMu TupleToolVertexCCMisppMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexCCMisppMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexCCMisppMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexCCMisppMuMu( ){}; ///< Destructor
