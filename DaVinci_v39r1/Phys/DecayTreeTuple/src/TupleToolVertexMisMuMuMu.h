#ifndef WSUTCLIFFE_TupleToolVertexMisMuMuMu_H
#define WSUTCLIFFE_TupleToolVertexMisMuMuMu_H 
...
/** @class TupleToolVertexMisMuMuMu TupleToolVertexMisMuMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexMisMuMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexMisMuMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexMisMuMuMu( ){}; ///< Destructor
