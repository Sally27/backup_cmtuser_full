#ifndef WSUTCLIFFE_TupleToolVertexthreeSSmuonDatapmMuMu_H
#define WSUTCLIFFE_TupleToolVertexthreeSSmuonDatapmMuMu_H 
...
/** @class TupleToolVertexthreeSSmuonDatapmMuMu TupleToolVertexthreeSSmuonDatapmMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexthreeSSmuonDatapmMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexthreeSSmuonDatapmMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexthreeSSmuonDatapmMuMu( ){}; ///< Destructor
