...
// local
#include "TupleToolVertexMisOSppMuMu.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexMisOSppMuMu
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexMisOSppMuMu )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexMisOSppMuMu::TupleToolVertexMisOSppMuMu( const std::string& type,
...
StatusCode TupleToolVertexMisOSppMuMu::initialize()
{
...
StatusCode TupleToolVertexMisOSppMuMu::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexMisOSppMuMu.cpp :(" );
		  ...
		  if(mumid==443)
		  {
			  ...
			  if(!((*isource)->daughters().empty())){
				  ...
				  for( LHCb::Particle::ConstVector::const_iterator itmp = tmp.begin(); 
					  ...
					  target.push_back(*itmp);
					  //          cout<<"daugther Particle id: "<<(*itmp)->particleID().pid()<<" Wooooohoooooooooooooooooooooooo!"<<endl;
					  if (((*itmp)->particleID().abspid()  == 13) && flag==1)
					  {
...
//
//=========================================================================
StatusCode TupleToolVertexMisOSppMuMu::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexMisOSppMuMu::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexMisOSppMuMu::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexMisOSppMuMu::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
