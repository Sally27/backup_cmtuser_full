...
DECLARE_TOOL_FACTORY( TupleTTInfo3sta )
...
TupleTTInfo3sta::TupleTTInfo3sta( const std::string& type,
...
TupleTTInfo3sta::~TupleTTInfo3sta() {} ;

//=============================================================================
// Initialization
//=============================================================================

StatusCode TupleTTInfo3sta::initialize() {
...
//  Finalize
//=============================================================================
StatusCode TupleTTInfo3sta::finalize() {
...
bool TupleTTInfo3sta::hasTrack( const LHCb::Particle* P ) const 
{
...
StatusCode TupleTTInfo3sta::fill( const LHCb::Particle* mother, 
                              ...
                              Tuples::Tuple& tuple )
{
  ...
  if ( hasTrack( P ) )
  {
    ...
    const LHCb::State& stateOrVelo = track->closestState(0);
    const LHCb::State& stateOrTT = track->closestState(2000);
    const LHCb::State& stateOrTT2 = track->closestState(3000); 
    const LHCb::State& stateOrOT = track->closestState(6000);
    const LHCb::State* stateTT = track->stateAt( LHCb::State::AtTT );
    
    test &= tuple->column(prefix + "_OriginVelo_"      , stateOrVelo.position() );
    test &= tuple->column(prefix + "_OriginVelo_qOverp", stateOrVelo.qOverP() );
   
    test &= tuple->column(prefix + "_OriginTT_"      , stateOrTT.position() );
    test &= tuple->column(prefix + "_OriginTT_qOverp", stateOrTT.qOverP() );

    test &= tuple->column(prefix + "_OriginTT2_"      , stateOrTT2.position() );
    test &= tuple->column(prefix + "_OriginTT2_qOverp", stateOrTT2.qOverP() );

    test &= tuple->column(prefix + "_OriginOT_"      , stateOrOT.position() );
    test &= tuple->column(prefix + "_OriginOT_qOverp", stateOrOT.qOverP() );
