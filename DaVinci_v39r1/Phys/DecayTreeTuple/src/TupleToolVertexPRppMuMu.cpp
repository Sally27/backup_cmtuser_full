...
// local
#include "TupleToolVertexPRppMuMu.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexPRppMuMu
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexPRppMuMu )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexPRppMuMu::TupleToolVertexPRppMuMu( const std::string& type,
...
StatusCode TupleToolVertexPRppMuMu::initialize()
{
...
StatusCode TupleToolVertexPRppMuMu::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexPRppMuMu.cpp :(" );
  ...
  do {
    ...
    for(LHCb::Particle::ConstVector::const_iterator isource = source.begin(); 
      ...
      if(!((*isource)->daughters().empty())){
        charge=(*isource)->charge();
//        cout<<"charge of mum: "<<charge<<endl;
//        cout<<"pp part: "<<endl;
...
//          cout<<count<<endl;
                ...
                if (((*itmp)->particleID().abspid()  == m_Xid) && (charge == (*itmp)->charge()))

                {
                parts2Vertex.push_back(*itmp);
                pro_part = (*itmp);
//                cout<<"X_ID part:  "<< (*itmp)->particleID().pid()<<endl;
                }
...
//
//=========================================================================
StatusCode TupleToolVertexPRppMuMu::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexPRppMuMu::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexPRppMuMu::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexPRppMuMu::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
