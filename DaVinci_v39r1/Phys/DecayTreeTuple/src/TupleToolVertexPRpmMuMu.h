#ifndef WSUTCLIFFE_TupleToolVertexPRpmMuMu_H
#define WSUTCLIFFE_TupleToolVertexPRpmMuMu_H 
...
/** @class TupleToolVertexPRpmMuMu TupleToolVertexPRpmMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexPRpmMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexPRpmMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexPRpmMuMu( ){}; ///< Destructor
