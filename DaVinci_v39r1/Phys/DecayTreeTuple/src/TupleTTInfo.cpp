...
DECLARE_TOOL_FACTORY( TupleTTInfo )
...
TupleTTInfo::TupleTTInfo( const std::string& type,
...
TupleTTInfo::~TupleTTInfo() {} ;

//=============================================================================
// Initialization
//=============================================================================

StatusCode TupleTTInfo::initialize() {
...
//  Finalize
//=============================================================================
StatusCode TupleTTInfo::finalize() {
...
bool TupleTTInfo::hasTrack( const LHCb::Particle* P ) const 
{
...
StatusCode TupleTTInfo::fill( const LHCb::Particle* mother, 
                              ...
                              Tuples::Tuple& tuple )
{
  ...
  if ( hasTrack( P ) )
  {
    ...
    const LHCb::State& stateOr = track->closestState(0);
