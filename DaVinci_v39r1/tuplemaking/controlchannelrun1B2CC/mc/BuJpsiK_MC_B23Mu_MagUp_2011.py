...
#
from StrippingArchive.Stripping20r1.StrippingB2XMuMu import B2XMuMuConf as builder
from StrippingArchive.Stripping20r1.StrippingB2XMuMu import defaultConfig as config
...
stripsel = AutomaticData(Location = "Phys/StrippingBetaSBu2JpsiKDetachedLine/Particles")
...
from Configurables import DaVinci
DaVinci().TupleFile = "BuKMuMuMC2011.root"
