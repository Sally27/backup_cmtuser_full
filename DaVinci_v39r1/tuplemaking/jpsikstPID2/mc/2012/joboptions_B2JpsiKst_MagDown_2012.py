...
myJobName = 'DownB2JpsiKstMC'
myApplication = DaVinci(version="v39r1")
#myApplication = DaVinci(version="v36r7p4")
### Define job-options file
myApplication.optsfile = ['/home/hep/ss4314/cmtuser/DaVinci_v39r1/tuplemaking/jpsikstPID2/mc/2012/BuJpsiKst_MC_2012_Down.py']
...
bk_down = BKQuery("/MC/2012/Beam4000GeV-2012-MagDown-Nu2.5-Pythia8/Sim08f/Digi13/Trig0x409f0045/Reco14a/Stripping20NoPrescalingFlagged/11144001/ALLSTREAMS.DST") 
data=bk_down.getDataset() 
