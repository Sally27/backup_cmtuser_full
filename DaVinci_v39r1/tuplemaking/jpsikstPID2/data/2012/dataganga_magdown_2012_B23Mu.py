...
job_name = '2012DownB2JpsiKst'

#sandbox = []

#dv = DaVinci()
dv = DaVinci(version="v39r1", optsfile = [ '/home/hep/ss4314/cmtuser/DaVinci_v39r1/tuplemaking/jpsikstPID2/data/2012/B2JpsiKst_2012.py' ]) #dv = DaVinci( version = 'v32r2p15', setupProjectOptions = '--nightly lhcb-branches Tue', platform = 'x86_64-slc5-gcc46-opt') #to run nightlies on LSF
