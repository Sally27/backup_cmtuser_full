...
job_name = 'MisIDOS15restrip'

#sandbox = []

#dv = DaVinci()
dv = DaVinci(version="v39r1", platform = 'x86_64-slc6-gcc48-opt', optsfile = [ '/home/hep/ss4314/cmtuser/DaVinci_v39r1/tuplemaking/misidrestripping2015/runosmisidrestripping2015.py' ])
...
bk_down = BKQuery("/LHCb/Collision15/Beam6500GeV-VeloClosed-MagDown/Real Data/Reco15a/Stripping24/90000000/SEMILEPTONIC.DST")
data = bk_down.getDataset()

bk_up = BKQuery("/LHCb/Collision15/Beam6500GeV-VeloClosed-MagUp/Real Data/Reco15a/Stripping24/90000000/SEMILEPTONIC.DST")
...
j.inputfiles =[ LocalFile("/home/hep/ss4314/cmtuser/DaVinci_v39r1/tuplemaking/misidrestripping2015/weights_110614_Lc_pX.xml")]
