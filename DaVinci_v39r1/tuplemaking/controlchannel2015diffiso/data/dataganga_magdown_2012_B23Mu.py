...
#dv = DaVinci()
dv = DaVinci(version="v39r1", optsfile = [ '/home/hep/ss4314/cmtuser/DaVinci_v39r1/tuplemaking/controlchannel/data/BuJpsiK_data_2012_B23Mu.py' ]) #dv = DaVinci( version = 'v32r2p15', setupProjectOptions = '--nightly lhcb-branches Tue', platform = 'x86_64-slc5-gcc46-opt') #to run nightlies on LSF
...
bk_down = BKQuery("/LHCb/Collision12/Beam4000GeV-VeloClosed-MagDown/Real Data/Reco14/Stripping20/90000000/DIMUON.DST")
