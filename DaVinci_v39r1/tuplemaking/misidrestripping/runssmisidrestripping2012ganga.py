...
job_name = '12MisIDSSrestrip'

#sandbox = []

#dv = DaVinci()
dv = DaVinci(version="v39r1", platform = 'x86_64-slc6-gcc48-opt', optsfile = [ '/home/hep/ss4314/cmtuser/DaVinci_v39r1/tuplemaking/misidrestripping/runssmisidrestripping2012.py' ])
...
bk_down = BKQuery("/LHCb/Collision12/Beam4000GeV-VeloClosed-MagDown/Real Data/Reco14/Stripping21r0p1a/90000000/SEMILEPTONIC.DST")
data = bk_down.getDataset()

bk_up = BKQuery("/LHCb/Collision12/Beam4000GeV-VeloClosed-MagUp/Real Data/Reco14/Stripping21r0p1a/90000000/SEMILEPTONIC.DST")
...
j.inputfiles =[ LocalFile("/home/hep/ss4314/cmtuser/DaVinci_v39r1/tuplemaking/misidrestripping/weights_110614_Lc_pX.xml")]
