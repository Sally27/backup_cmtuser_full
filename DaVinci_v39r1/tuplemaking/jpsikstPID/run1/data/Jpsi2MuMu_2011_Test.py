...
tuple = DecayTreeTuple("Jpsi2mumu_Tuple")

tuple.Inputs = ["/Event/Dimuon/Phys/BetaSJpsi2MuMuDetachedLine/Particles"]
...
#from Configurables import DaVinci
DaVinci().TupleFile = "Jpsi2MuMu.root"
...
IOHelper().inputFiles(['./00041840_00001132_1.dimuon.dst'], clear=True)
