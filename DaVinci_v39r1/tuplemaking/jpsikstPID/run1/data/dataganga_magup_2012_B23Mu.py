...
job_name = '2012UpB2XmumuDATA'

#sandbox = []

#dv = DaVinci()
dv = DaVinci(version="v39r1", platform = 'x86_64-slc6-gcc48-opt', optsfile = [ '/home/hep/ss4314/cmtuser/DaVinci_v39r1/tuplemaking/controlchannelrun1B2CC/data/BuJpsiK_data_2012_B23Mu.py' ]) #dv = DaVinci( version = 'v32r2p15', setupProjectOptions = '--nightly lhcb-branches Tue', platform = 'x86_64-slc5-gcc46-opt') #to run nightlies on LSF
...
#bk_down = BKQuery(type="Run",i"/LHCb/Collision12/Beam4000GeV-VeloClosed-MagUp/RealData/Reco14/90000000/FULL.DST")

bk_down = BKQuery("/LHCb/Collision12/Beam4000GeV-VeloClosed-MagUp/Real Data/Reco14/Stripping21/90000000/DIMUON.DST")
...
#j.inputsandbox =["/home/hep/ss4314/cmtuser/DaVinci_v39r1/tuplemaking/controlchannelrun1B2CC/data/weights_110614_Lc_pX.xml"]
j.inputfiles = [ LocalFile ("/home/hep/ss4314/cmtuser/DaVinci_v39r1/tuplemaking/controlchannelrun1B2CC/data/weights_110614_Lc_pX.xml")]
