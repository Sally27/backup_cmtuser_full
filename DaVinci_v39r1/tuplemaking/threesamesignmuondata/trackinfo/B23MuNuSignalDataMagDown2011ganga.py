...
job_name = 'B23SameMuNuDatalMagDown2011'

#sandbox = []

#dv = DaVinci()
dv = DaVinci(version="v39r1", platform = 'x86_64-slc6-gcc48-opt', optsfile = [ '/home/hep/ss4314/cmtuser/DaVinci_v39r1/tuplemaking/threesamesignmuondata/trackinfo/B23SameSignMuNuData2011.py' ])
...
bk_down = BKQuery("/LHCb/Collision11/Beam3500GeV-VeloClosed-MagDown/Real Data/Reco14/Stripping21r1/90000000/SEMILEPTONIC.DST")
