...
from DecayTreeTuple.Configuration import *
from Configurables import TupleTTInfo
tuple.mu1.addTool(TupleTTInfo)
tuple.mu1.ToolList+=["TupleTTInfo"]

from DecayTreeTuple.Configuration import *
from Configurables import TupleTTInfo
tuple.mu2.addTool(TupleTTInfo)
tuple.mu2.ToolList+=["TupleTTInfo"]

from DecayTreeTuple.Configuration import *
from Configurables import TupleTTInfo
tuple.mu3.addTool(TupleTTInfo)
tuple.mu3.ToolList+=["TupleTTInfo"]

from DecayTreeTuple.Configuration import *
from Configurables import TupleTTInfo
tuple.Bplus.addTool(TupleTTInfo)
tuple.Bplus.ToolList+=["TupleTTInfo"]
