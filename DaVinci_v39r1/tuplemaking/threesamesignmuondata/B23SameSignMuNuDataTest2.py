...
from DecayTreeTuple.Configuration import *
from Configurables import TupleTTInfo2
tuple.mu1.addTool(TupleTTInfo2)
tuple.mu1.ToolList+=["TupleTTInfo2"]

from DecayTreeTuple.Configuration import *
from Configurables import TupleTTInfo2
tuple.mu2.addTool(TupleTTInfo2)
tuple.mu2.ToolList+=["TupleTTInfo2"]

from DecayTreeTuple.Configuration import *
from Configurables import TupleTTInfo2
tuple.mu3.addTool(TupleTTInfo2)
tuple.mu3.ToolList+=["TupleTTInfo2"]

from DecayTreeTuple.Configuration import *
from Configurables import TupleTTInfo2
tuple.Bplus.addTool(TupleTTInfo2)
tuple.Bplus.ToolList+=["TupleTTInfo2"]
