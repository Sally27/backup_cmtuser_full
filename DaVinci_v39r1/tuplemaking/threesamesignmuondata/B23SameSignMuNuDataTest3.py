...
from DecayTreeTuple.Configuration import *
from Configurables import TupleTTInfo3
tuple.mu1.addTool(TupleTTInfo3)
tuple.mu1.ToolList+=["TupleTTInfo3"]

from DecayTreeTuple.Configuration import *
from Configurables import TupleTTInfo3
tuple.mu2.addTool(TupleTTInfo3)
tuple.mu2.ToolList+=["TupleTTInfo3"]

from DecayTreeTuple.Configuration import *
from Configurables import TupleTTInfo3
tuple.mu3.addTool(TupleTTInfo3)
tuple.mu3.ToolList+=["TupleTTInfo3"]

from DecayTreeTuple.Configuration import *
from Configurables import TupleTTInfo3
tuple.Bplus.addTool(TupleTTInfo3)
tuple.Bplus.ToolList+=["TupleTTInfo3"]
