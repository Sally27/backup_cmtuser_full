...
#
from StrippingArchive.Stripping24.StrippingB2CC.StrippingB2JpsiXforBeta_s import B2JpsiXforBeta_sConf as builder
from StrippingArchive.Stripping24.StrippingB2CC.StrippingB2JpsiXforBeta_s import default_config as config
...
from Configurables import DaVinci
DaVinci().TupleFile = "BuKMuMuMC2015_Strip24.root"
...
IOHelper().inputFiles(['./00052017_00000012_3.AllStreams.dst'], clear=True)
