...
myJobName = 'UpB2JpsiKMC'
myApplication = DaVinci(version="v39r1")
#myApplication = DaVinci(version="v36r7p4")
### Define job-options file
myApplication.optsfile = ['/home/hep/ss4314/cmtuser/DaVinci_v39r1/tuplemaking/controlchannelrun1B2CC_checktruthmatch/mcDIY/BuJpsiK_MC_B23Mu_MagUp_2012.py']
...
bk_down = BKQuery("/MC/2012/Beam4000GeV-2012-MagUp-Nu2.5-Pythia6/Sim08e/Digi13/Trig0x409f0045/Reco14a/Stripping20NoPrescalingFlagged/12143001/ALLSTREAMS.DST") 
data=bk_down.getDataset() 
bk_down2 = BKQuery("/MC/2012/Beam4000GeV-2012-MagUp-Nu2.5-Pythia8/Sim08e/Digi13/Trig0x409f0045/Reco14a/Stripping20NoPrescalingFlagged/12143001/ALLSTREAMS.DST")
