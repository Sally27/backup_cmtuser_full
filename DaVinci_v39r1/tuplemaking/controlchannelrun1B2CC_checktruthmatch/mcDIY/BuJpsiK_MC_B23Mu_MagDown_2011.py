...
#
from testlocallyStrip21 import B2JpsiXforBeta_sConf as builder
from testlocallyStrip21 import default_config as config
...
from Configurables import DaVinci
DaVinci().TupleFile = "BuKMuMuMC2011_Strip21locally_noKaonPID_noMuonPID.root"
