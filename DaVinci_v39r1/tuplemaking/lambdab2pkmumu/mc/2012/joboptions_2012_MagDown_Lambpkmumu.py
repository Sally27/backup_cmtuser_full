...
myJobName = 'DownLambdaB2JpsipKMC'
myApplication = DaVinci(version="v39r1")
#myApplication = DaVinci(version="v36r7p4")
### Define job-options file
myApplication.optsfile = ['/home/hep/ss4314/cmtuser/DaVinci_v39r1/tuplemaking/lambdab2pkmumu/mc/2012/Lambdab2jpsikpi_OriginalDescriptor_MagDown.py']
...
bk_down = BKQuery("/MC/2012/Beam4000GeV-2012-MagDown-Nu2.5-Pythia8/Sim08i/Digi13/Trig0x409f0045/Reco14c/Stripping21r0p1NoPrescalingFlagged/15144001/ALLSTREAMS.DST") 
data=bk_down.getDataset() 
bk_down2 = BKQuery("/MC/2012/Beam4000GeV-2012-MagDown-Nu2.5-Pythia8/Sim08a/Digi13/Trig0x409f0045/Reco14a/Stripping20NoPrescalingFlagged/15144001/ALLSTREAMS.DST")
data.extend(bk_down2.getDataset())
bk_down3 = BKQuery("/MC/2012/Beam4000GeV-2012-MagDown-Nu2.5-Pythia8/Sim08b/Digi13/Trig0x409f0045/Reco14a/Stripping20NoPrescalingFlagged/15144001/ALLSTREAMS.DST")
