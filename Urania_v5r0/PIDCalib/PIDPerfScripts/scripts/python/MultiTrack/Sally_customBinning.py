...
for trType in ["K"]:
    ...
    # momentum
    AddBinScheme(trType, 'P', 'Sally', 3000, 100000)
    AddBinBoundary(trType, 'P', 'Sally', 9300)
    AddBinBoundary(trType, 'P', 'Sally', 15600) 
    AddBinBoundary(trType, 'P', 'Sally', 19000)
    AddBinBoundary(trType, 'P', 'Sally', 24400)
    AddBinBoundary(trType, 'P', 'Sally', 29800)
    AddBinBoundary(trType, 'P', 'Sally', 35200)
    AddBinBoundary(trType, 'P', 'Sally', 40600)
    AddBinBoundary(trType, 'P', 'Sally', 46000)
    AddBinBoundary(trType, 'P', 'Sally', 51400)
    AddBinBoundary(trType, 'P', 'Sally', 56800)
    AddBinBoundary(trType, 'P', 'Sally', 62200)
    AddBinBoundary(trType, 'P', 'Sally', 67600)
    AddBinBoundary(trType, 'P', 'Sally', 73000)
    AddBinBoundary(trType, 'P', 'Sally', 78400)
    AddBinBoundary(trType, 'P', 'Sally', 83800)
    AddBinBoundary(trType, 'P', 'Sally', 89200)
    AddBinBoundary(trType, 'P', 'Sally', 94600)

    # eta
    AddBinScheme(trType, 'ETA', 'Sally', 1.5, 5)

    # nTrack
    AddBinScheme(trType, 'nTracks', 'Sally', 0, 500)
