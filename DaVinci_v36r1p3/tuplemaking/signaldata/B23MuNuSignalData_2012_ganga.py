...
for polarity in ["MagUp", "MagDown"]:
	...
	job_name = 'StrippingB23MuNusignal'+polarity+'2012'

	dv = DaVinci(version="v36r1p3", platform = 'x86_64-slc6-gcc48-opt', optsfile = [ '/home/hep/ss4314/cmtuser/DaVinci_v36r1p3/tuplemaking/signaldata/B23MuNuSignalData_2012.py' ])

	t = JobTemplate(application = dv)

	print "Now reading the data"

	bk_down = BKQuery(path="/LHCb/Collision12/Beam4000GeV-VeloClosed-"+polarity+"/Real Data/Reco14/Stripping21/90000000/SEMILEPTONIC.DST",dqflag="OK")
