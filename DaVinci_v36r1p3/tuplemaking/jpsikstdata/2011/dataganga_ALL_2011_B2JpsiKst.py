...
for polarity in ["MagDown"]:
	job_name = '2011'+polarity+'B2JspiKstDATA'

	dv = DaVinci(version="v36r1p3", platform = 'x86_64-slc6-gcc48-opt', optsfile = [ '/home/hep/ss4314/cmtuser/DaVinci_v36r1p3/tuplemaking/jpsikstdata/2011/B2JpsiKst_2011.py'])

	t = JobTemplate(application = dv)

	print "Now reading the data"

	bk_down = BKQuery(path="/LHCb/Collision11/Beam3500GeV-VeloClosed-"+polarity+"/Real Data/Reco14/Stripping20r1/90000000/DIMUON.DST",dqflag="OK")
