...
for polarity in ["MagUp", "MagDown"]:
    ...
    myJobName = 'NewMCtagcorrect'+polarity
    myApplication = DaVinci(version="v36r1p3", platform = 'x86_64-slc6-gcc48-opt')
    myApplication.optsfile = ['/home/hep/ss4314/cmtuser/DaVinci_v36r1p3/tuplemaking/signalmc/B23MuNuSignalSelection'+polarity+'.py']
    
    
    #Inputdata
    
    bk_down = BKQuery(path="/MC/2012/Beam4000GeV-2012-"+polarity+"-Nu2.5-Pythia6/Sim08h/Digi13/Trig0x409f0045/Reco14c/Stripping20NoPrescalingFlagged/12513070/ALLSTREAMS.DST",dqflag="OK")
    ...
    bk_down2 = BKQuery(path="/MC/2012/Beam4000GeV-2012-"+polarity+"-Nu2.5-Pythia8/Sim08h/Digi13/Trig0x409f0045/Reco14c/Stripping20NoPrescalingFlagged/12513070/ALLSTREAMS.DST",dqflag="OK")
