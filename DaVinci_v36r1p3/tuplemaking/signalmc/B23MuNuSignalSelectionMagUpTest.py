...
#from DecayTreeTuple.Configuration import *
#from Configurables import TupleToolL0PtLUT
...
from DecayTreeTuple.Configuration import *
from Configurables import TupleToolL0PtLUT
tuple.Bplus.addTool(TupleToolL0PtLUT)
#tuple.Bplus.TupleToolL0PtLUT.LUT="LUT-M1M2-L0PT.txt"
tuple.Bplus.TupleToolL0PtLUT.LUT_loc="/home/hep/ss4314/cmtuser/DaVinci_v36r1p3/tuplemaking/signalmc/LUT-M1M2-L0PT.txt"
tuple.Bplus.ToolList+=["TupleToolL0PtLUT"]


from DecayTreeTuple.Configuration import *
from Configurables import TupleToolL0PtLUT
tuple.mu1.addTool(TupleToolL0PtLUT)
#tuple.Bplus.TupleToolL0PtLUT.LUT="LUT-M1M2-L0PT.txt"
tuple.mu1.TupleToolL0PtLUT.LUT_loc="/home/hep/ss4314/cmtuser/DaVinci_v36r1p3/tuplemaking/signalmc/LUT-M1M2-L0PT.txt"
tuple.mu1.ToolList+=["TupleToolL0PtLUT"]

from DecayTreeTuple.Configuration import *
from Configurables import TupleToolL0PtLUT
tuple.mu2.addTool(TupleToolL0PtLUT)
#tuple.Bplus.TupleToolL0PtLUT.LUT="LUT-M1M2-L0PT.txt"
tuple.mu2.TupleToolL0PtLUT.LUT_loc="/home/hep/ss4314/cmtuser/DaVinci_v36r1p3/tuplemaking/signalmc/LUT-M1M2-L0PT.txt"
tuple.mu2.ToolList+=["TupleToolL0PtLUT"]

from DecayTreeTuple.Configuration import *
from Configurables import TupleToolL0PtLUT
tuple.mu3.addTool(TupleToolL0PtLUT)
#tuple.Bplus.TupleToolL0PtLUT.LUT="LUT-M1M2-L0PT.txt"
tuple.mu3.TupleToolL0PtLUT.LUT_loc="/home/hep/ss4314/cmtuser/DaVinci_v36r1p3/tuplemaking/signalmc/LUT-M1M2-L0PT.txt"
tuple.mu3.ToolList+=["TupleToolL0PtLUT"]
...
from Configurables import DaVinci
DaVinci().TupleFile = "Bplus23munu_TestL0Match.root"
