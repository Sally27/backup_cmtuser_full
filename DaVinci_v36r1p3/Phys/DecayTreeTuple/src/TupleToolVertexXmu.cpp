...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexXmu
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexXmu )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexXmu::TupleToolVertexXmu( const std::string& type,
...
StatusCode TupleToolVertexXmu::initialize()
{
...
StatusCode TupleToolVertexXmu::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexXmu.cpp :(" );
 ...
 //               if (((*itmp)->particleID().abspid()  == m_Xid) && count==1)
                ...
                pro_part = (*itmp);
                cout<<"X_ID part: "<<endl;
                cout<<"ID of particle 1: "<< (*itmp)->particleID().pid()<<endl;
                }
                ...
                mu_part = (*itmp);
                cout<<"Mu part: "<<endl;
                cout<<"ID of particle 3: "<< (*itmp)->particleID().pid()<<endl;      
                }
...
//
//=========================================================================
StatusCode TupleToolVertexXmu::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexXmu::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexXmu::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexXmu::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
