...
DECLARE_TOOL_FACTORY( TupleTTInfo2 )
...
TupleTTInfo2::TupleTTInfo2( const std::string& type,
...
TupleTTInfo2::~TupleTTInfo2() {} ;

//=============================================================================
// Initialization
//=============================================================================

StatusCode TupleTTInfo2::initialize() {
...
//  Finalize
//=============================================================================
StatusCode TupleTTInfo2::finalize() {
...
bool TupleTTInfo2::hasTrack( const LHCb::Particle* P ) const 
{
...
StatusCode TupleTTInfo2::fill( const LHCb::Particle* mother, 
                              ...
                              Tuples::Tuple& tuple )
{
  ...
  if ( hasTrack( P ) )
  {
    ...
    const LHCb::State& stateOr = track->closestState(150);
