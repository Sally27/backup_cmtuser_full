#ifndef WSUTCLIFFE_TupleToolVertexCCMismpMuMu_H
#define WSUTCLIFFE_TupleToolVertexCCMismpMuMu_H 
...
/** @class TupleToolVertexCCMismpMuMu TupleToolVertexCCMismpMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexCCMismpMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexCCMismpMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexCCMismpMuMu( ){}; ///< Destructor
