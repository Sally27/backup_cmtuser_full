#ifndef WSUTCLIFFE_TupleToolVertexCCMispmMuMu_H
#define WSUTCLIFFE_TupleToolVertexCCMispmMuMu_H 
...
/** @class TupleToolVertexCCMispmMuMu TupleToolVertexCCMispmMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexCCMispmMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexCCMispmMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexCCMispmMuMu( ){}; ///< Destructor
