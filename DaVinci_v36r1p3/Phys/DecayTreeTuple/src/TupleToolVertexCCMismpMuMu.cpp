...
// local
#include "TupleToolVertexCCMismpMuMu.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexCCMismpMuMu
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexCCMismpMuMu )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexCCMismpMuMu::TupleToolVertexCCMismpMuMu( const std::string& type,
...
StatusCode TupleToolVertexCCMismpMuMu::initialize()
{
...
StatusCode TupleToolVertexCCMismpMuMu::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexCCMismpMuMu.cpp :(" );
...
//              cout<<"Pro part: "<<"ID of particle 1: "<< (*itmp)->particleID().pid()<<endl;
              }
...
//          cout<<"Particle charge:"<<(*itmp)->charge();
...
//
//=========================================================================
StatusCode TupleToolVertexCCMismpMuMu::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexCCMismpMuMu::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexCCMismpMuMu::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexCCMismpMuMu::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
