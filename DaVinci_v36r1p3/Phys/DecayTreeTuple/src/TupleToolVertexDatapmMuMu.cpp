...
// local
#include "TupleToolVertexDatapmMuMu.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexDatapmMuMu
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexDatapmMuMu )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexDatapmMuMu::TupleToolVertexDatapmMuMu( const std::string& type,
...
StatusCode TupleToolVertexDatapmMuMu::initialize()
{
...
StatusCode TupleToolVertexDatapmMuMu::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexDatapmMuMu.cpp :(" );
...
//
//=========================================================================
StatusCode TupleToolVertexDatapmMuMu::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexDatapmMuMu::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexDatapmMuMu::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexDatapmMuMu::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
