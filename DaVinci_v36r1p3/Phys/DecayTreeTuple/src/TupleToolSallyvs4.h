...
/** @class TupleToolSallyvs4 TupleToolSallyvs4.h jborel/TupleToolSallyvs4.h
 *
 *
 * \sa DecayTreeTuple
 *
...
class TupleToolSallyvs4 : public TupleToolBase, virtual public IParticleTupleTool {

public:
  /// Standard constructor
  TupleToolSallyvs4( const std::string& type,
		    const std::string& name,
		    const IInterface* parent);

  virtual ~TupleToolSallyvs4(){}; ///< Destructor
