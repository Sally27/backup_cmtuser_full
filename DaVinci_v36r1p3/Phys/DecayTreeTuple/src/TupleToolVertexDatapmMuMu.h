#ifndef WSUTCLIFFE_TupleToolVertexDatapmMuMu_H
#define WSUTCLIFFE_TupleToolVertexDatapmMuMu_H 
...
/** @class TupleToolVertexDatapmMuMu TupleToolVertexDatapmMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexDatapmMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexDatapmMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexDatapmMuMu( ){}; ///< Destructor
