#ifndef WSUTCLIFFE_TupleToolVertexCCPiMuMuMu_H
#define WSUTCLIFFE_TupleToolVertexCCPiMuMuMu_H 
...
/** @class TupleToolVertexCCPiMuMuMu TupleToolVertexCCPiMuMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexCCPiMuMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexCCPiMuMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexCCPiMuMuMu( ){}; ///< Destructor
