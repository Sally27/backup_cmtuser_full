#ifndef WSUTCLIFFE_TupleToolVertexMisOSpmMuMu_H
#define WSUTCLIFFE_TupleToolVertexMisOSpmMuMu_H 
...
/** @class TupleToolVertexMisOSpmMuMu TupleToolVertexMisOSpmMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexMisOSpmMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexMisOSpmMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexMisOSpmMuMu( ){}; ///< Destructor
