...
void invmass()
{
  ...
  TFile* f = new TFile("DVtuple10000ev20150413tauchangede_25andmaxwidth2p085.root");
  TTree* t = (TTree*)f->Get("MCDecayTreeTuple/MCDecayTree");

  TFile *f1 = new TFile("MassDVtuple10000ev20150413tauchangede_25andmaxwidth2p085.root","RECREATE");
