...
tsvc.EvtGenDecay.UserDecayFile = "Bu_Kstmumu.init2.dec"
...
#ParticlePropertySvc().Particles = [ "K*(892)+     38      323  1.0    0.891660    1.295693e-26      K*+   323   2.085",
#                                    "K*(892)-     39     -323 -1.0    0.891660    1.295693e-26     K*-  -323   2.085"]
