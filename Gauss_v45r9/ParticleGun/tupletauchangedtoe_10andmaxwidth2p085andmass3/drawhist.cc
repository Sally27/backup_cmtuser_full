...
void hist()
{
 ...
 DataSample hist3("/home/hep/ss4314/cmtuser/Gauss_v45r9/ParticleGun/tupletauchangedtoe_10andmaxwidth2p085andmass3/masstupletauchangedtoe_26andmaxwidth2p085andmass3.root", "KstarMass");
  TH1F* c = new TH1F("KstarMassfinal4", "KstarMassfinal4", 100, -10 , 10000);
 ...
 DataSample hist4("/home/hep/ss4314/cmtuser/Gauss_v45r9/ParticleGun/tupletauchangedtoe_10andmaxwidth2p085andmass3/masstupletauchangedtoe_26andmaxwidth2p085andmass4.root", "KstarMass");
  TH1F* d = new TH1F("KstarMass_", "KstarMass_", 100, -10 , 10000);
  hist4.t->Draw("KstarMassfinal >> KstarMass_");
 ...
 *               ha->Draw("same");*/
    ...
    leg->AddEntry(b,"Kstar mass with tau 10^-26 maxwidth 2.085 mass 2 Gev","l");   // h1 and h2 are histogram pointers
    leg->AddEntry(a,"Kstar mass with tau 10^-26 maxwidth 2.085 mass 0.89 Gev","l");
    leg->AddEntry(c,"Kstar mass with tau 10^-26 maxwidth 2.085 mass 3 Gev","l");
    leg->AddEntry(d,"Kstar mass with tau 10^-26 maxwidth 2.085 mass 4 Gev","l");
