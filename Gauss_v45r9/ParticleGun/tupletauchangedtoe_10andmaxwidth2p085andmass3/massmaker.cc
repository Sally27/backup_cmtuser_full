...
void invmass()
{
  ...
  TFile* f = new TFile("DVtupletauchangedtoe_26andmaxwidth2p085nomasschange.root");
  TTree* t = (TTree*)f->Get("MCDecayTreeTuple/MCDecayTree");

  TFile *f1 = new TFile("massplayagaine_26andmaxwidth2p085nomasschangecheckingM.root","RECREATE");
...
/*  gStyle->SetOptStat(0);*/	
   ...
   Int_t count,count2;
   Double_t BplusMassfinal, KstarMassfinal, q2, Kstarmade;
   ...
   TBranch *bpt4 = t2->Branch("KstarMassmade",&Kstarmade,"Kstarmade/D");
   count=0;
   count2=0;

   TLorentzVector BplusMass, KstarMass, muplus, muplus0, muminus, KstarMassmade, nu_mu;
