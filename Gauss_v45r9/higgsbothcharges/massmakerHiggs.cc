...
void invmass()
{
  Double_t H_20_TRUEP_X, H_20_TRUEP_Y, H_20_TRUEP_Z, H_20_TRUEP_E;
...
/*  gStyle->SetOptStat(0);*/	
   ...
   t->SetBranchAddress("H_20_TRUEP_X", &H_20_TRUEP_X);
   t->SetBranchAddress("H_20_TRUEP_Y", &H_20_TRUEP_Y);
   t->SetBranchAddress("H_20_TRUEP_Z", &H_20_TRUEP_Z);
   t->SetBranchAddress("H_20_TRUEP_E", &H_20_TRUEP_E);
   ...
   for(int i(0); i<t->GetEntries(); ++i)
   {
      ...
      KstarMass[3] = H_20_TRUEP_E;
      KstarMass[0] = H_20_TRUEP_X;
      KstarMass[1] = H_20_TRUEP_Y;
      KstarMass[2] = H_20_TRUEP_Z;
