...
/** @class TupleToolSallyvs2 TupleToolSallyvs2.h jborel/TupleToolSallyvs2.h
 *
 *
 * \sa DecayTreeTuple
 *
...
class TupleToolSallyvs2 : public TupleToolBase, virtual public IParticleTupleTool {

public:
  /// Standard constructor
  TupleToolSallyvs2( const std::string& type,
		    const std::string& name,
		    const IInterface* parent);

  virtual ~TupleToolSallyvs2(){}; ///< Destructor
