#ifndef TUPLETOOLSALLY_H
#define TUPLETOOLSALLY_H 1
...
/** @class TupleToolSally TupleToolSally.h jborel/TupleToolSally.h
 *
 *
 * \sa DecayTreeTuple
 *
...
class IVertexFit;
class TupleToolSally : public TupleToolBase, virtual public IParticleTupleTool {

public:
  /// Standard constructor
  TupleToolSally( const std::string& type,
		    const std::string& name,
		    const IInterface* parent);

  virtual ~TupleToolSally(){}; ///< Destructor
