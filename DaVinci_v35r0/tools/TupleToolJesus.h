#ifndef TUPLETOOLJESUS_H
#define TUPLETOOLJESUS_H 1
...
/** @class TupleToolJesus TupleToolJesus.h jborel/TupleToolJesus.h
 *
 *
 * \sa DecayTreeTuple
 *
...
class TupleToolJesus : public TupleToolBase, virtual public IParticleTupleTool {

public:
  /// Standard constructor
  TupleToolJesus( const std::string& type,
		    const std::string& name,
		    const IInterface* parent);

  virtual ~TupleToolJesus(){}; ///< Destructor
