...
from StrippingSelections.StrippingB23MuNu import B23MuNuConf
from StrippingSelections.StrippingB23MuNu import defaultConfig
...
tuple2.mu1.addTool(TupleToolVertexXmu)
tuple2.mu1.ToolList+=["TupleToolVertexXmu"]
