...
from StrippingSelections.misidsally import B23MuNuConf
from StrippingSelections.misidsally import defaultConfig
...
LoKi_Jpsi1=tuple.Jpsi.addTupleTool("LoKi::Hybrid::TupleTool/LoKi_Jpsi")
...
LoKi_Jpsi2=tuple2.Jpsi.addTupleTool("LoKi::Hybrid::TupleTool/LoKi_Jpsi2")
LoKi_Jpsi2.Variables = {
       'TAU' : "BPVLTIME()",
       'DIRA_OWNPV' : "BPVDIRA",
       'FD_CHI2' : "BPVVDCHI2",
       'ENDVERTEX_CHI2' : "VFASPF(VCHI2/VDOF)",
...
tuple2.mu1.addTool(TupleToolVertexMisMuMuMu)
tuple2.mu1.ToolList+=["TupleToolVertexMisMuMuMu"]


from DecayTreeTuple.Configuration import *
from Configurables import TupleToolVertexMisppMuMu
tuple2.mu1.addTool(TupleToolVertexMisppMuMu)
tuple2.mu1.ToolList+=["TupleToolVertexMisppMuMu"]


from DecayTreeTuple.Configuration import *
from Configurables import TupleToolVertexMispmMuMu
tuple2.mu1.addTool(TupleToolVertexMispmMuMu)
tuple2.mu1.ToolList+=["TupleToolVertexMispmMuMu"]


from DecayTreeTuple.Configuration import *
from Configurables import TupleToolVertexMismpMuMu
tuple2.mu1.addTool(TupleToolVertexMismpMuMu)
tuple2.mu1.ToolList+=["TupleToolVertexMismpMuMu"]
