...
tuple.mu1.addTool(TupleToolVertexppMuMu)
tuple.mu1.ToolList+=["TupleToolVertexppMuMu"]

from DecayTreeTuple.Configuration import *
from Configurables import TupleToolVertexpmMuMu
tuple.mu1.addTool(TupleToolVertexpmMuMu)
tuple.mu1.ToolList+=["TupleToolVertexpmMuMu"]

from DecayTreeTuple.Configuration import *
from Configurables import TupleToolVertexmpMuMu
tuple.mu1.addTool(TupleToolVertexmpMuMu)
tuple.mu1.ToolList+=["TupleToolVertexmpMuMu"]

from DecayTreeTuple.Configuration import *
from Configurables import TupleToolVertexMuMuMu
tuple.mu1.addTool(TupleToolVertexMuMuMu)
tuple.mu1.ToolList+=["TupleToolVertexMuMuMu"]
