#ifndef WSUTCLIFFE_TupleToolVertexXmu_H
#define WSUTCLIFFE_TupleToolVertexXmu_H 
...
/** @class TupleToolVertexXmu TupleToolVertexXmu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexXmu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexXmu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexXmu( ){}; ///< Destructor
