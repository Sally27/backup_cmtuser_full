...
job_name = 'StrippingB23MuNusignalMagDown2011'

#sandbox = []

#dv = DaVinci()
dv = DaVinci(version="v35r0", platform = 'x86_64-slc6-gcc48-opt', optsfile = [ '/home/hep/ss4314/cmtuser/DaVinci_v35r0/run3withisolationandvertexandnshared/B23MuNuSignalData.py' ])
...
j.inputfiles =[LocalFile("/home/hep/ss4314/cmtuser/DaVinci_v35r0/run3withisolationandvertexandnshared/weights_110614_Lc_pX.xml")]
