...
job_name = 'StrippingB23MuNusignalMagUp'

#sandbox = []

#dv = DaVinci()
dv = DaVinci(version="v35r0", platform = 'x86_64-slc6-gcc48-opt', optsfile = [ '/afs/cern.ch/user/s/slstefko/cmtuser/DaVinci_v35r0/signaldatarun/run3withisolationandvertexandnshared/B23MuNuSignalData.py' ])
