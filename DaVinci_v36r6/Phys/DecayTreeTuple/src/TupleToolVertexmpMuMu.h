#ifndef WSUTCLIFFE_TupleToolVertexmpMuMu_H
#define WSUTCLIFFE_TupleToolVertexmpMuMu_H 
...
/** @class TupleToolVertexmpMuMu TupleToolVertexmpMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexmpMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexmpMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexmpMuMu( ){}; ///< Destructor
