...
// local
#include "TupleToolApplyPiMuIsolation.h"
...
DECLARE_TOOL_FACTORY( TupleToolApplyPiMuIsolation );

using namespace LHCb;
//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
TupleToolApplyPiMuIsolation::TupleToolApplyPiMuIsolation( const std::string& type,
...
StatusCode TupleToolApplyPiMuIsolation::initialize() {
...
StatusCode TupleToolApplyPiMuIsolation::fill( const Particle* mother
                                    , const Particle* P
...
//		if ((*itmp)->particleID().abspid()  == 2212 || (*itmp)->particleID().abspid() == 13)
                if ((*itmp)->particleID().abspid() == 13 || (*itmp)->particleID().abspid() == 211)
		{
...
//  
//=========================================================================
const Vertex* TupleToolApplyPiMuIsolation::originVertex( const Particle* top
...
//=============================================================================
bool TupleToolApplyPiMuIsolation::isTrackInDecay(const LHCb::Track* track, std::vector<const LHCb::Track*> daughters){
...
//=============================================================================
double TupleToolApplyPiMuIsolation::getminipchi(const LHCb::Particle* track){
...
double TupleToolApplyPiMuIsolation::getfdchi2(const LHCb::Track* track, LHCb::Vertex Vtx){
...
double TupleToolApplyPiMuIsolation::getM(std::vector<const LHCb::Particle*> pvect ,std::vector<double> Mvect)
    {
...
//=============================================================================
double TupleToolApplyPiMuIsolation::getopening(const LHCb::Track* track,const  LHCb::Particle* P){
