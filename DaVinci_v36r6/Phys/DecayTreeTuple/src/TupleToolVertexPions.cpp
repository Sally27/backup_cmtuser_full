...
// local
#include "TupleToolVertexPions.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolVertexPions
//
...
DECLARE_TOOL_FACTORY( TupleToolVertexPions )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  TupleToolVertexPions::TupleToolVertexPions( const std::string& type,
...
StatusCode TupleToolVertexPions::initialize()
{
...
StatusCode TupleToolVertexPions::fill( const Particle* mother
                                    , const Particle* P
                                    ...
                                    , Tuples::Tuple& tuple )
{
  ...
  Assert( P && mother && m_dist
          , "This should not happen, you are inside TupleToolVertexPions.cpp :(" );
...
//
//=========================================================================
StatusCode TupleToolVertexPions::fillVertex( const LHCb::VertexBase* vtx,
...
double TupleToolVertexPions::Mcorr(TLorentzVector Y, TVector3 M_dirn)
{
     double P_T = (Y.Vect()).Perp(M_dirn);
     return  sqrt(Y.M2() + P_T * P_T) + P_T;
}

std::vector<TLorentzVector> TupleToolVertexPions::recoNu(TLorentzVector Y, TVector3 M_dirn, double mass)
    {
...
std::vector<double> TupleToolVertexPions::Mcorr_errors(TVector3 v1, TVector3 v2, TLorentzVector p,  Gaudi::SymMatrix7x7 cov1, Gaudi::SymMatrix3x3 cov2 )
{
