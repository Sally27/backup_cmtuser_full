#ifndef WSUTCLIFFE_TupleToolVertexMismpMuMu_H
#define WSUTCLIFFE_TupleToolVertexMismpMuMu_H 
...
/** @class TupleToolVertexMismpMuMu TupleToolVertexMismpMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexMismpMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexMismpMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexMismpMuMu( ){}; ///< Destructor
