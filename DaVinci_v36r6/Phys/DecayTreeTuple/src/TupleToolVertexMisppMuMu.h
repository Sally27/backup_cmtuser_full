#ifndef WSUTCLIFFE_TupleToolVertexMisppMuMu_H
#define WSUTCLIFFE_TupleToolVertexMisppMuMu_H 
...
/** @class TupleToolVertexMisppMuMu TupleToolVertexMisppMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexMisppMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexMisppMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexMisppMuMu( ){}; ///< Destructor
