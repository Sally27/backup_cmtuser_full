#ifndef WSUTCLIFFE_TupleToolVertexppMuMu_H
#define WSUTCLIFFE_TupleToolVertexppMuMu_H 
...
/** @class TupleToolVertexppMuMu TupleToolVertexppMuMu.h
 *
 ...
 *  @date   2008-04-15
 */
class TupleToolVertexppMuMu : public TupleToolBase,
...
public:
  ...
  TupleToolVertexppMuMu( const std::string& type,
                     const std::string& name,
                     const IInterface* parent);

  virtual ~TupleToolVertexppMuMu( ){}; ///< Destructor
